      ...
      <div className="grid lg:grid-cols-3 gap-12 items-center max-w-7xl m-auto">
        ...
        <div className="order-2 lg:order-2  col-span-1">
          <div className="space-y-6 text-lg text-gray-600">
            <p>
              Get a comprehensive view of your entire school's performance at a
              glance. Our intuitive dashboard provides real-time insights into
              student progress, financial health, and administrative efficiency.
            </p>
            <div className="pt-4">
